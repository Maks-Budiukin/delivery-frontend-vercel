...
import { StyledSection, StyledLink, StyledButton, NavList, NavBar, LogoLink, Logo, StyledClearButton, AuthBlock, BurgerMenuWrapper, MobileBurgerMenuWrapper} from "./Navbar.styled"
    ...
    return (<><StyledSection>
                <NavBar>
                    ...
                    {isMobile && 
                        <NavList>
                            {cart.length > 0 && <StyledClearButton type="button" onClick={() => dispatch(ClearCartThunk())}>Clear Cart</StyledClearButton>}
                            <StyledButton type="button" onClick={showMobMenu} >Shops</StyledButton>
